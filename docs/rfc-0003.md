...
| Versão | Marcador | Alterações |
|---------|----------|------------|
| Legado | Nenhum | Nenhuma estrutura de prefixo |
| v1 | \'a\' | Estrutura de prefixo adicionada |
| v2 | \'b\' | Codificação de prefixo melhorada |
| v3 | \'c\' | Codificação de corpo otimizada |
| v4 | \'d\' | Atual (BSP v5) |
...
body = "ytvjmjccj" (base-29)
body_len = 9

byte_len_encoded = "f" (5 em base-29)
byte_len_size = 1 → "b"

body_len_encoded = "j" (9 em base-29)
body_len_size = 1 → "b"

prefix = "b" + "f" + "b" + "j" = "bfbj"
result = "d" + "bfbj" + "ytvjmjccj" = "dbfbjytvjmjccj"
```

**Saída**: `"dbfbjytvjmjccj"`
