...
*   Permitir verificação de integridade por chunk de forma independente
*   Suportar recursos futuros como verificação em fluxo

**Nota**: O download seletivo de chunks arbitrários para descompressão isolada não é suportado quando a compressão monolítica Zstandard é aplicada ao arquivo inteiro antes do fatiamento (conforme definido na Seção 3.1). Neste modelo, a descompressão de um chunk requer todos os chunks anteriores. A RFC 0006 documenta este trade-off e as abordagens alternativas.
...
```json
{
  "f": "document.pdf",
  "s": 92079,
  "h": "8228b41a0e8db20358e79230eba51960c9271bc33781ce8d4de366d6d78b5b0b",
  "c": 3,
  "v": "v5",
  "chk": [
...
Ver [RFC 0005](rfc-0005.md) — Modo Estrito e Verificação Offline para a especificação completa do comportamento em modo estrito.
...
```
SHA-256: aacfcdeea1a9cab6962549314fa6a4a8157dd35594c558c825eb7ec75b3814f9
```
