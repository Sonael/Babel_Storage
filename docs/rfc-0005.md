...
|-------------|-------------|--------------|
| Incompatibilidade de hash de chunk |  Aviso, continuar |  Abortar imediatamente |
| Incompatibilidade de hash de arquivo |  Aviso, retornar erro |  Abortar, excluir arquivo |
| Coordenadas ausentes |  Aviso, pular chunk |  Abortar imediatamente |
| Assinatura inválida |  Aviso, continuar |  Abortar imediatamente |
| Contagem de chunks errada |  Aviso, reconstruir |  Abortar imediatamente |
...
def verify_chunk_strict(chunk_data: bytes, 
    ...
    if actual_hash != expected_hash:
        raise RuntimeError(
            f"MODO ESTRITO: Incompatibilidade de SHA-256 do chunk {chunk_index}\n"
...
```
[ERRO] MODO ESTRITO: Incompatibilidade de SHA-256 do chunk 15
...
```
[ERRO] MODO ESTRITO: Incompatibilidade de SHA-256 do arquivo final
